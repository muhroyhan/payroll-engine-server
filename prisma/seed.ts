  ...
  const employeeData = [
    {
      ...
      ptkpStatus: $Enums.PtkpStatus.K1,
      hasNpwp: true,
      isBpjsKesehatanParticipant: true,
      isBpjsKetenagakerjaanParticipant: true,
      npwpNumber: '12.345.678.9-001.000',
      baseSalary: 8500000,
    ...
    },
    {
      ...
      employeeType: $Enums.EmployeeType.permanent,
      ptkpStatus: $Enums.PtkpStatus.K0,
      hasNpwp: true,
      isBpjsKesehatanParticipant: true,
      isBpjsKetenagakerjaanParticipant: true,
      npwpNumber: '12.345.678.9-002.000',
      baseSalary: 9500000,
    ...
    },
    {
      ...
      ptkpStatus: $Enums.PtkpStatus.TK0,
      hasNpwp: false,
      isBpjsKesehatanParticipant: true,
      isBpjsKetenagakerjaanParticipant: true,
      npwpNumber: null,
    ...
    },
    {
      ...
      position: 'Accountant',
      employeeType: $Enums.EmployeeType.permanent,
      ptkpStatus: $Enums.PtkpStatus.K2,
      hasNpwp: true,
      isBpjsKesehatanParticipant: true,
      isBpjsKetenagakerjaanParticipant: true,
      npwpNumber: '12.345.678.9-004.000',
      baseSalary: 10250000,
    ...
    },
    {
      ...
      employeeType: $Enums.EmployeeType.contract,
      ptkpStatus: $Enums.PtkpStatus.TK1,
      hasNpwp: true,
      isBpjsKesehatanParticipant: false,
      isBpjsKetenagakerjaanParticipant: true,
      npwpNumber: '12.345.678.9-005.000',
      baseSalary: 7000000,
